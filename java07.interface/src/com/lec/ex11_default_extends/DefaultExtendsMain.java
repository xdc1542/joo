...
/*
	디폴트메서드가 있는 인터페이싀 상속과 구현
	
	인터페이산에도 상속이 가능하기 때문에 부모인터페이스에 디폴트메서드가 정의 되어 있는 경우
	자식인터페이스에서 디폴트메서들 활용하는 방법은 3가지가 있다.
...
public class DefaultExtendsMain {
	...
	public static void main(String[] args) {
		...
		// 1. 디폴트메서드상속
		ChidInterface1 ci1 = new ChidInterface1() {
		...
		// 2. 디폴트메서드재정의
		ChidInterface2 ci2 = new ChidInterface2() {
			public void method1() { /* 실행문 */ }
			public void method3() { /* 실행문 */ }
		};
		ci2.method1();
		ci2.method2(); // 부모의 default메서드 재정의
		ci2.method3();
		
		
		// 3. 디폴트메서드를 추상메서드로 재선언
		ChidInterface3 ci3 = new ChidInterface3() {
			public void method1() { /* 실행문 */ }
