...
/*
	Properties는 Hashtable의 하위클래스이기 때문에 Hashtable의 모든 속성을 그대로 가지로 있다.
	차이점 Hashtable은 키와 값에 다양한 참조타입으로 정의할 수 있지만 Properties는 키와 값의
	데이터타입은 오직 String타입으로만 정의할 수 있게 제한된 Map컬렉션이다.
	
	Properties는 애플케이션의 옵션정보, 데이터베이스의 연결정보, 그리고 국제화(다국어)정보가
