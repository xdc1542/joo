...
public class DeleteMessageService {
	...
	public void deleteMessage(int id, String pw) {
		...
		try {
			...
			if(message==null) throw new MessageNotFoundException(id + "번 메시지를 찾지 못했거나 메시지가 등록되지 않았습니다!");
			if(!message.matchPassword(pw)) throw new InvalidPasswordException("비밀번호가 틀립니다! 다시 입력하세요!");
