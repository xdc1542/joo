...
/*
	1. 배열이란?
	   ...
	   필요하게 된다. 이런 방법은 비효율적이고 번거로운 코딩이 된다.
	   동일타입의 많은 양의 데이터를 사용할 경우에는 좀 더 효율적인 방법으로 데이터를 저장할
	   필요가 있는데 이런 방법을 지원하는 것이 배열(Array)이다.
	...
	4. 배열의 제약사항
       ...
       1) 배열의 크기(길이)는 한번 정의가 되면 변경할 수 없다. 즉, 고정이 되어 있다. 
...
public class ArrayMain1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(scores.toString());   // 메모리주소 : 문자열(15진수)
		System.out.println();
		...
		// 실습. 각 점수와 총점출력을 출력해보기
		// for : scores[0] = " + scores[0] ~ 12를 각각 출력하고
		// 총점 = ???, 평균 = ???
		int sum = 0;
