...
<!-- 
    ...
    tomcat과 같은 컨테이너(웹서버)는 JSP를 분석하는 과정에서(~.java파일 생성) 어떤 인코딩을
    ...
    1. 파일이 BOM으로 시작하지 않을 경우
       ...
       b. pageEncoding값을 가지고 있을 경우, 파일을 읽을 때 해당속성값을 문자셋으로 사용
       c. pageEncoding값이 없을 경우 contentType의 charset속성값을 사용
       d. 상기 모두 해당되지 않을 경우에는 기본문자셋인 ISO-8859-1문자셋을 사용
       
    2. 파일이 BOM으로 시작할 경우
       
       a. BOM을 이용해서 결정된 인코딩을 이용해서 파일을 읽고 pageEncoding를 검색
