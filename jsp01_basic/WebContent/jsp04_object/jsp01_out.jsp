...
<!-- 
	...
	A. 기본객체
	   ...
	   7. page(java.lang.Object) : JSP페이지를 구현현 java클래스의 인스턴스(객체)
...
<!-- 
	1. out 기본객체
	   ...
	   2) out객체의 buffer관련 메서드
	      ...
	      c. clear()         : 버퍼전체를 비움, 이미 flush가 되어 있다면 익셉션 발생
	      d. clearBuffer()   : 버퍼전체를 비움, 이미 flush가 되어 있다면 익셉션 발생시키지 않음
	      e. flush()         : 버퍼를 flush처리
