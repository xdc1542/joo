...
<!--  
	...
	1. page
	   ...
	   어오면 jsp페이지를 실행하는 데 이 때 jsp페이지를 실행하는 범위가 page
	   영역이다. 이 영역은 pageContext객체의 영역이다.
	...
	하거나 공유하기 위한 목적으로 사용한다. 속성은 key와 값형태로 갖는데 기
	본객체는 서러 다른 이름을 갖는 속성을 여러개 포함할 수가 있다.
